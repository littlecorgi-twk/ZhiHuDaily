...
import com.example.a1203.zhihudaily.Listern.OnBannerClickListener;
...
public class Banner extends FrameLayout {
    ...
    private void reset(){
        ...
        for (int i = 0; i < topStoriesList.size(); i++) {
            ...
            Constant.getImageLoader().displayImage(topStoriesList.get(i).getImage(), imageView, Constant.getDisplayImageOptions());
